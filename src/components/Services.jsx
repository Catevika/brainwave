				...
				<div className="relative">
					...
					<div className="relative z-1 grid gap-5 lg:grid-cols-2">
						<div className="relative min-h-156 border border-n-1/10 rounded-3xl overflow-hidden">
							...
							<div className="absolute inset-0 flex flex-col justify-end p-8 bg-linear-to-b from 8/0 to-n-8/90 lg:p-15">
									...
									{brainwaveServicesIcons.map((item, i) => (
										<li
											className={`flex items-center justify-center ${
												i === 2 ?
													"rounded-2xl w-12 h-12 p-0.25 bg-conic-gradient md:w-18"
